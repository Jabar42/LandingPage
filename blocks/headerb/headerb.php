    ...
    <div class="container mx-auto px-4 py-20"> 
        <div class="-mx-4 flex flex-wrap items-end"> 
            ...
            <div class="px-4 w-full lg:w-1/3"> 
                <div class="bg-white mb-0 p-4 rounded-xl shadow-xl" id="contact_form_mailer_id">
                    ...
                    <?php if( !$mailer->processed || $mailer->error) : ?>
                        ...
                        <?php if( !$mailer->processed || $mailer->error) : ?>
                            <form action="<?php echo '#contact_form_mailer_id'; ?>" method="post" onsubmit="event.stopImmediatePropagation();event.stopPropagation();" id="contact_form_mailer_id">
                                ...
                                <div class="flex my-4 text-sm">
                                    ...
                                    <input type="email" class="block border border-gray-300 flex-1 px-3 py-2 rounded-r-md w-full hover:bg-blue-50" placeholder="Email" aria-label="Email" required name="contact_form_mailer_id_1" value="<?php echo ( isset( $_POST['contact_form_mailer_id_1'] ) ? $_POST['contact_form_mailer_id_1'] : '' ); ?>">
                                </div>
 ...
 (Required)', 'landingpage' ); ?></p>
                                <div>
                                    <div class="border flex items-start mt-4 p-3 rounded-xl hover:bg-blue-50">
                                        <input id="remember_me" name="remember_me" type="checkbox" class="border-gray-300 h-4 mt-1 rounded text-indigo-600 w-4 focus:ring-indigo-500" <?php echo ( isset( $_POST['remember_me'] ) ? 'checked' : '' ); ?>>
